...
SEED_CRIMES: list[dict] = [
    {"id": 1, "type": "homicide", "title": "Good Samaritan fatally shot trying to stop flower robbery", "address": "100 block Upland Blvd near Jones Blvd", "lat": 36.1595, "lng": -115.2238, "time": "2026-07-30 17:00", "description": "Man intervened when suspect robbed a woman selling flowers. Suspect (Rodger Harrison, 28) arrested nearby. Charges: open murder, robbery, CCW.", "source": "seed"},
    {"id": 2, "type": "shooting", "title": "Officer-involved shooting at Walmart — Boulder Hwy", "address": "5100 block Boulder Highway", "lat": 36.1002, "lng": -115.0615, "time": "2026-07-21 06:00", "description": "Physical altercation inside business escalated. Suspect exited with firearm; officer discharged. Suspect deceased; second male critical. 8th OIS of 2026.", "source": "seed"},
    {"id": 3, "type": "homicide", "title": "Gang-related shooting near Hollywood Regional Park", "address": "1500 block S Hollywood Blvd", "lat": 36.1520, "lng": -115.0450, "time": "2026-07-18 14:30", "description": "Carlos Valenzuela, 20, killed. Cousins Jayden Torres (19) and Kassandra Orozco (16) arrested on open murder charges.", "source": "seed"},
    {"id": 4, "type": "robbery", "title": "Deadly parking-garage robbery spree (Strip area)", "address": "Fashion Show mall / Strip parking structures", "lat": 36.1275, "lng": -115.1715, "time": "2026-07-30 (court)", "description": "Jordan Ruby pleaded guilty in high-profile robbery spree that killed two victims, including a senior.", "source": "seed"},
    {"id": 5, "type": "homicide", "title": "Murder-suicide investigated", "address": "Las Vegas valley (LVMPD)", "lat": 36.1699, "lng": -115.1398, "time": "2026-07-21", "description": "LVMPD investigating murder-suicide. Details limited pending investigation.", "source": "seed"},
    {"id": 6, "type": "assault", "title": "Shooting leaves one dead — update, additional suspect arrested", "address": "West Las Vegas area", "lat": 36.1750, "lng": -115.2100, "time": "2026-07-27", "description": "Additional suspect arrested in connection with earlier fatal shooting.", "source": "seed"},
    {"id": 7, "type": "theft", "title": "Vehicle theft cluster — Boulder Falls area", "address": "5800 Boulder Falls St", "lat": 36.0550, "lng": -115.0800, "time": "2026-07-28", "description": "Multiple vehicle theft reports in southeast valley neighborhoods.", "source": "seed"},
    {"id": 8, "type": "burglary", "title": "Residential burglary — N Buffalo Dr", "address": "2600 N Buffalo Dr", "lat": 36.1950, "lng": -115.2600, "time": "2026-07-25", "description": "Breaking & entering reported; investigation ongoing.", "source": "seed"},
    {"id": 9, "type": "robbery", "title": "Attempted business robbery — Flamingo / Jones area", "address": "Near Jones & Flamingo", "lat": 36.1150, "lng": -115.2250, "time": "2026-07-22", "description": "Suspect fled after attempting to rob business. Public asked for tips.", "source": "seed"},
    {"id": 10, "type": "shooting", "title": "Shooting investigation — NE Las Vegas business", "address": "4900 block E Craig Rd near Nellis", "lat": 36.2400, "lng": -115.0600, "time": "2026-06-19 (still active case)", "description": "Man killed, woman injured after verbal altercation escalated to gunfire. Suspect fled.", "source": "seed"},
    ...
    {"id": 13, "type": "assault", "title": "Aggravated assault — Downtown area", "address": "Near Fremont St / Downtown", "lat": 36.1699, "lng": -115.1398, "time": "2026-07-26", "description": "Assault reported; suspect description released by LVMPD.", "source": "seed"},
    ...
    {"id": 15, "type": "other", "title": "Vehicle vs pedestrian — fatal collision", "address": "W Sahara Ave at S Torrey Pines", "lat": 36.1440, "lng": -115.2700, "time": "2026-07-23", "description": "Fatal traffic collision investigated as Fatal #67.", "source": "seed"},
]
...
NEW_CRIME_POOL = [
    {"type": "theft", "title": "Catalytic converter theft reported", "address": "3200 block E Tropicana Ave", "lat": 36.1005, "lng": -115.1050, "description": "Vehicle parts theft. Suspect vehicle described as dark sedan."},
    {"type": "assault", "title": "Simple assault outside casino", "address": "Near Las Vegas Blvd / Flamingo", "lat": 36.1147, "lng": -115.1728, "description": "Altercation outside property; one transported with non-life-threatening injuries."},
    {"type": "robbery", "title": "Strong-arm robbery — pedestrian", "address": "1600 block E Charleston Blvd", "lat": 36.1590, "lng": -115.1300, "description": "Victim approached from behind; phone and wallet taken. Suspect fled on foot."},
    {"type": "burglary", "title": "Garage burglary — Summerlin area", "address": "Near Far Hills / Town Center", "lat": 36.1650, "lng": -115.3200, "description": "Tools and bicycle taken from open garage overnight."},
    {"type": "shooting", "title": "Shots fired call — no victims located", "address": "2800 block N Las Vegas Blvd", "lat": 36.2050, "lng": -115.1200, "description": "Multiple 911 calls of gunfire. Officers canvassed; no injuries found. Shell casings recovered."},
]
...
def start_poller() -> None:
    ...
    print(f"LVMPD ArcGIS poller started (every {POLL_INTERVAL_SEC}s, limit={POLL_LIMIT})")
...
def health_payload() -> dict:
    """Shared body for /health, /healthz, and /api/health."""
    with _lock:
